// src/features/tasks/components/StatusDropdown.tsx
  ...
  return (
    <>
      ...
      {open && menuPos && ReactDOM.createPortal(
        <div
          ref={menuRef}
          className="bg-white border border-gray-200 rounded-lg shadow-xl z-[9999] min-w-[140px] max-w-[160px] flex flex-col"
